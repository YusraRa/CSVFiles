...
import com.tsfn.service.CSVLinkedInFileService;
...
public class CSVLinkedInFileController {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<List<LinkedInFile>> getAllLinkedInFiles() {
        try {
            List<LinkedInFile> linkedInFiles = linkedInFileService.getAllLinkedInFiles();
